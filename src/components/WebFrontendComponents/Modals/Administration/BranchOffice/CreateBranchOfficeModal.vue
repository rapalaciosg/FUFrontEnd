    ...
    <template v-slot:modal-body>
      <form @submit.prevent="onSubmit">
        <div class="grid grid-cols-2 gap-5 py-6">
          <Textinput type="text" label="Nombre" placeholder="Nombre" v-model="branchOfficeName" :error="branchOfficeNameError" />
          <Textinput type="text" label="Ruc" placeholder="Ruc" v-model="ruc" :error="rucError" />
          <Textinput type="text" label="Dv" placeholder="Dv" v-model="dv" :error="dvError" />
          <Textinput type="text" label="Dirección" placeholder="Dirección" v-model="address" :error="addressError" />
          <Textinput type="text" label="Teléfono" placeholder="Teléfono" v-model="phone" :error="phoneError" />
          <Textinput type="email" label="Correo" placeholder="Correo" v-model="email" :error="emailError" />
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const { mutate: createBranchOffice } = useMutation(CREATE_BRANCH_OFFICE, () => ({
