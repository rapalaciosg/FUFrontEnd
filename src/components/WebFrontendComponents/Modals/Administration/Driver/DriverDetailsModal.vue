  ...
  <modal-base :activeModal="activeModal">
    <template v-slot:modal-body>
      <div class="grid grid-cols-2 gap-5 px-4 py-6">
        ...
        <p>{{ data.keycloakUser }}</p>
        <p class="font-medium">Vehículo asociado:</p>
        <p v-if="data.vehicleAssociation">{{ data.vehicleAssociation.vehicle.code }}</p>
        <p v-else><strong>Sin vehículo asociado</strong></p>
