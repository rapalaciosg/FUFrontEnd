...
import { GET_ALL_SPECIAL_PRICES, UPDATE_SPECIAL_PRICE } from "@/services/clients/specialPrices/specialPricesGraphql.js";
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const { mutate: updateSpecialPrice } = useMutation(UPDATE_SPECIAL_PRICE, () => ({ variables: { inputModel: specialPrice } }));
