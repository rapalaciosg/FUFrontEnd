<template>
  ...
  >
    <span
      class="relative lg:h-[32px] lg:w-[32px] lg:bg-gray-500-f7 bg-primaryBase lg:dark:bg-slate-900 dark:text-white text-white cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center"
